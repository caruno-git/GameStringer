# 🎮 Digest Traduzioni Videogiochi — 6 giugno 2026

> Digest mattutino GameStringer. Esecuzione automatica — scelte prese autonomamente, nessuna modifica al codice applicata.
> **TL;DR:** Giornata tranquilla, in continuità con il 5 giugno. **Nessun drift di versione**: XUnity 5.6.1, BepInEx 5.4.23.5 / 6.0.0-pre.2 / Legacy 5.4.11, IPA 3.4.1, MelonLoader 0.7.3 (non scaricato dal progetto) restano allineati agli upstream. Sul fronte ITA nessuna patch genuinamente nuova rispetto a ieri (resta da confermare a mano **Blood.West v4.6.2**). Nessun nuovo annuncio di localizzazione ufficiale: il **Summer Game Fest 2026** (5 giu) ha portato decine di reveal ma nessun annuncio ITA-specifico in finestra. Fronte LLM e RSS invariati.
...
> XUnity.AutoTranslator resta a **5.6.1** (ultima release GitHub 19/04/2026, nessuna successiva). BepInEx 6 stabile ancora non pubblicato: solo `6.0.0-pre.2` + bleeding-edge (i build > `6.0.0-be.697` introdurranno breaking change verso la prima v6 stabile). Nessun motivo di muovere i pin attuali.
...
> **Nessuna patch ITA genuinamente nuova oggi** rispetto al digest del 5 giugno. Le voci sopra sono riportate per continuità settimanale ed erano già nei digest precedenti. Citati anche, come riferimento di catalogo (non novità in finestra): Magicraft (update 20 mag, compatibile Steam v1.2.23) e Impetum (storyline 100%, ultimo agg. 29 apr). RomHack Plaza non ha esposto nuove patch ITA databili in finestra (solo titoli retro NES/SNES/PS1 già archiviati).
...
- **Summer Game Fest 2026** (showcase 5 giu): decine di reveal (Resident Evil Veronica, Final Fantasy VII Revelation, Lords of the Fallen 2, The Wolf Among Us 2, ecc.), ma **nessun annuncio di localizzazione ITA specifico** emerso in finestra. Da monitorare nei prossimi giorni man mano che escono le schede prodotto con le lingue supportate.
...
| MelonLoader | v0.7.3 (~mag 2026) | non hard-coded | ➖ N/A (loader non scaricato dal progetto) |
| UnrealLocres | v1.1.1 (nessuna nuova release) | n/a | ➖ Nessuna novità |
| UnityEx | nessuna novità databile | n/a | ➖ Nessuna novità |

**Provider LLM (segnalazioni da verificare):** quadro invariato. I comparativi 2026 continuano a indicare **Gemini 3.1 Pro** in testa ai benchmark generalisti (leader OpenMark marzo 2026) e **DeepL** forte su UI strings e lingue europee con la velocità più alta. **Claude** resta indicato tra i migliori per l'italiano e su testo tone-sensitive. Nessun annuncio nuovo databile in finestra. Il setup attuale di GameStringer (Gemini Flash default, Claude Sonnet 4.6, DeepL) resta valido.
...
- [Summer Game Fest 2026 — annunci (Multiplayer.it)](https://multiplayer.it/articoli/summer-game-fest-2026-tutti-gli-annunci-e-i-giochi-presentati-sul-palco-di-geoff-keighley.html) · [First Playable 2026 (Firenze)](https://www.toscanafilmcommission.it/first-playable-2026-tutto-pronto-per-lottava-edizione-a-firenze/)
...
- [Best AI Translator 2026 (Pillitteri)](https://pasqualepillitteri.it/en/news/764/best-ai-translator-2026-deepl-chatgpt-claude-gemini-comparison) · [LLM Translation Benchmark 2026 (intlpull)](https://intlpull.com/blog/llm-translation-quality-benchmark-2026)
